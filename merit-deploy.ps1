...
function Write-EnvLocal {
    ...
    $baseUrl = Get-Setting -Settings $Settings -Name 'meritsubs_public_base_url' -Default 'https://somatune.vercel.app/api/meritsubs'
    ...
    $lines = @(
        ...
        '',
        "MERIT_METERED_API_BASE_URL=$(Get-Setting -Settings $Settings -Name 'merit_metered_api_base_url' -Default 'https://soulos.vercel.app')",
