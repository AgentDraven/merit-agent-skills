...
| Action | When | Command |
|--------|------|---------|
| Clone/download repo | Always first, because it brings down the skills, docs, templates, and `merit.ps1` / `merit.sh` CLI | `git clone --branch skills-v0.3.18 https://github.com/AgentDraven/merit-agent-skills.git` |
