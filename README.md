...
mkdir C:\MyMeritApp
cd C:\MyMeritApp
git clone --branch skills-v0.5.65 https://github.com/AgentDraven/merit-agent-skills.git
...
| Current tip (Portal pin) | **`skills-v0.5.63`** |
| Current human-validation baseline | **`skills-v0.5.63`** |
